...
const MyMapComponent = () => {
  ...
  if (existingMap) {
    console.log("map already exits")
    return; // Map already exists, do nothing.
  }
    var map = L.map('map').setView([63.835109, 23.150805], 15);
console.log("here kjhkjhkj")
    ...
    var swappedCoordinates = coordinates.map(function(coord) {
      return [coord[1], coord[0]];
    });

    var route = L.polyline(swappedCoordinates, { color: 'red' }).addTo(map);
